...
bool PluginCore::initPluginParameters()
{
	...
	piParam = new PluginParameter(controlID::W_f, "W_f", "", controlVariableType::kDouble, 0.000000, 10.000000, 2.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.000000);
	piParam->setBoundVariable(&W_f, boundVariableType::kDouble);
	addPluginParameter(piParam);

	piParam = new PluginParameter(controlID::W_h, "W_h", "", controlVariableType::kDouble, 0.010000, 5.000000, 0.010000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.000000);
	piParam->setBoundVariable(&W_h, boundVariableType::kDouble);
	addPluginParameter(piParam);

	piParam = new PluginParameter(controlID::U_f, "U_f", "", controlVariableType::kDouble, 0.000000, 6.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.000000);
	piParam->setBoundVariable(&U_f, boundVariableType::kDouble);
	addPluginParameter(piParam);

	piParam = new PluginParameter(controlID::U_h, "U_h", "", controlVariableType::kDouble, 0.000000, 4.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.000000);
	piParam->setBoundVariable(&U_h, boundVariableType::kDouble);
	addPluginParameter(piParam);

	piParam = new PluginParameter(controlID::b_f, "b_f", "", controlVariableType::kDouble, -2.000000, 5.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.000000);
	piParam->setBoundVariable(&b_f, boundVariableType::kDouble);
	addPluginParameter(piParam);

	piParam = new PluginParameter(controlID::dcf, "DC Filter On/Off", "OFF, ON", "OFF");
	piParam->setBoundVariable(&dcf, boundVariableType::kInt);
	addPluginParameter(piParam);
...
bool PluginCore::processAudioFrame(ProcessFrameInfo& processFrameInfo)
{
	...
	auto gruParams = gru_l.getParameters();
	gruParams.input_gain_dB = input_gain;
	gruParams.W_f = W_f;
	gruParams.W_h = W_h;
	gruParams.U_f = U_f;
	gruParams.U_h = U_h;
	gruParams.b_f = b_f;
	gruParams.dcf = convertIntToEnum(dcf, dcfStatus);
	gruParams.output_gain_dB = output_gain;

	gru_l.setParameters(gruParams);
	gru_r.setParameters(gruParams);

	double ynL = gru_l.processAudioSample(processFrameInfo.audioInputFrame[0]);
	...
	double ynR = gru_r.processAudioSample(processFrameInfo.audioInputFrame[1]);
